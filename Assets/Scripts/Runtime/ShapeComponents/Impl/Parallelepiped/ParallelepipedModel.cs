...
namespace Runtime.ShapeComponents.Impl.Parallelepiped
{
    public class ParallelepipedModel : ShapeModel
    {
        ...
        {
            { EShapeParameter.Width, new FloatParameter(EShapeParameter.Width, 1f, 1f, 10f) },
            { EShapeParameter.Height, new FloatParameter(EShapeParameter.Height, 1f, 1f, 10f) },
            { EShapeParameter.Depth, new FloatParameter(EShapeParameter.Depth, 1f, 1f, 10f) },
